        ...
        <main className="bg-[#02080B] ">
            ...
            <section className="bg-[#02080B]  bg-no-repeat"
                ...
                <div className="px-4  mt-4 flex gap-4 font-bold text-white w-[90%] flex-col lg:flex-row md:flex-row">
                    <button className="bg-[#0A5B68] hover:bg-[#02080B] text-white font-bold py-2 px-4 rounded">
                        All Funding Requests
                    </button>
                    <button className="bg-[#02080B] hover:bg-[#0A5B68] text-white border-[#C4D3D3] border font-bold py-2 px-4 rounded">
                        Submitted Requests
                    </button>
                </div>
                <div className='lg:w-[95%] md:w-[95%] w-[100%] mx-auto py-12 px-4 lg:px-0 md:px-0'>
                    <h2 className="px-4 lg:px-0 md:px-0 lg:text-[28px] md:text-[28px] text-[20px] mx-auto font-montserrat items-center text-center lg:text-left md:text-left text-white">Funding Requests </h2>
