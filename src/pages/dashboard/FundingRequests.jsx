                ...
                <Box sx={{ width: '100%', typography: 'body1', borderBottom: '1', borderColor: '#0A5B68' }}>
                    <TabContext value={value}>
                        <div className="px-4  mt-4 flex gap-4 font-bold text-white w-[90%] flex-col lg:flex-row md:flex-row">
                            <TabList onChange={handleChange} aria-label="lab API tabs example" textColor="#0A5B68">
                        ...
                        <TabPanel value="one">
                            <div className='lg:w-[100%] md:w-[100%] w-[100%] mx-auto py-12 px-4 lg:px-0 md:px-0'>
                                <h2 className="px-4 lg:px-0 md:px-0 lg:text-[28px] md:text-[28px] text-[20px] mx-auto font-montserrat items-center text-center lg:text-left md:text-left text-white">All Funding Requests </h2>
                        ...
                        <TabPanel value="two">
                            <div className='lg:w-[95%] md:w-[95%] w-[100%] mx-auto py-12 px-4 lg:px-0 md:px-0'>
                                <h2 className="px-4 lg:px-0 md:px-0 lg:text-[28px] md:text-[28px] text-[20px] mx-auto font-montserrat items-center text-center lg:text-left md:text-left text-white">Submitted Requests </h2>
                                <div className='flex lg:flex-row md:flex-row flex-col justify-between items-center my-10 flex-wrap'>
                                    <div className='lg:w-[32%] md:w-[32%] w-[100%] p-4  border-white bg-[#191F1C]/5 rounded-xl border shadow-lg'>
                                        <Link to={`/projectdetail`} className='text-white' >
                                            <img src={project1} alt="" className='w-[100%] h-[237px] object-cover object-center rounded-lg' />
