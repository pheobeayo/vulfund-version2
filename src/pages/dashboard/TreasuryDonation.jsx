    ...
    return (
        <main className="bg-[#02080B]">
            ...
            <section className="bg-[#02080B] bg-no-repeat "
                ...
                <Box sx={{ width: '100%', typography: 'body1', borderBottom: '1', borderColor: '#0A5B68' }}>
                    <TabContext value={value}>
                        <div className="px-4 mt-4 flex lg:flex-row md:flex-row flex-col justify-between font-bold text-white  w-[100%] ">
                            <div className="flex gap-2">
                                <TabList onChange={handleChange} aria-label="lab API tabs example" textColor="#0A5B68" hover='#0A5B68'>
                            ...
                            <div>
                                <h1 className="lg:px-0 md:px-0 lg:text-[20px] md:text-[20px] text-[16px] font-[700] mx-auto font-montserrat items-center text-center lg:text-left md:text-left text-white">10hrs 22mins left to vote</h1>
                            </div>
                        </div>
                        <TabPanel value="one">
                            <div className='lg:w-[100%] md:w-[100%] w-[100%] mx-auto py-12 px-4 lg:px-0 md:px-0'>
                                <h2 className="px-4 lg:px-0 md:px-0 lg:text-[28px] md:text-[28px] text-[20px] font-[700]  mx-auto font-montserrat items-center text-center lg:text-left md:text-left text-white flex justify-between">Top 5 leading Requests <span className="text-[#A3FFCE] text-[15px]"> View all top 5 requests </span> </h2>
                        ...
                        <TabPanel value="two">
                            <div className='lg:w-[100%] md:w-[100%] w-[100%] mx-auto py-12 px-4 lg:px-0 md:px-0'>
                                <h2 className="px-4 lg:px-0 md:px-0 lg:text-[28px] md:text-[28px] text-[20px] font-[700]  mx-auto font-montserrat items-center text-center lg:text-left md:text-left text-white flex justify-between">All Voted Projects <span className="text-[#A3FFCE] text-[15px]"> View all top 5 requests </span> </h2>
                                <div className='flex lg:flex-row md:flex-row flex-col justify-between items-center my-10 flex-wrap'>
                                    <div className='lg:w-[32%] md:w-[32%] w-[100%] p-4  border-white bg-[#191F1C]/5 rounded-xl border shadow-lg'>
                                        <Link to={`/projectdetail`} className='text-white' >
                                            <img src={project1} alt="" className='w-[100%] h-[237px] object-cover object-center rounded-lg' />
                        ...
                        <TabPanel value="three">
                            <div className='lg:w-[100%] md:w-[100%] w-[100%] mx-auto py-12 px-4 lg:px-0 md:px-0'>
                                <h2 className="px-4 lg:px-0 md:px-0 lg:text-[28px] md:text-[28px] text-[20px] font-[700]  mx-auto font-montserrat items-center text-center lg:text-left md:text-left text-white flex justify-between">All funded Projects <span className="text-[#A3FFCE] text-[15px]"> View all top 5 requests </span> </h2>
                                <div className='flex lg:flex-row md:flex-row flex-col justify-between items-center my-10 flex-wrap'>
                                    <div className='lg:w-[32%] md:w-[32%] w-[100%] p-4  border-white bg-[#191F1C]/5 rounded-xl border shadow-lg'>
                                        <Link to={`/projectdetail`} className='text-white' >
                                            <img src={project1} alt="" className='w-[100%] h-[237px] object-cover object-center rounded-lg' />
                        ...
                        <div className='lg:w-[100%] md:w-[100%] w-[100%] mx-auto py-12 px-4 lg:px-0 md:px-0'>
                            <h2 className="px-4 lg:px-0 md:px-0 lg:text-[28px] md:text-[28px] text-[20px] font-[700]  mx-auto font-montserrat items-center text-center lg:text-left md:text-left text-white ">More Funding Requests</h2>
                            <div className='flex lg:flex-row md:flex-row flex-col justify-between items-center my-10 flex-wrap'>
                                <div className='lg:w-[32%] md:w-[32%] w-[100%] p-4  border-white bg-[#191F1C]/5 rounded-xl border shadow-lg'>
                                    <Link to={`/projectdetail`} className='text-white' >
                                        <img src={project1} alt="" className='w-[100%] h-[237px] object-cover object-center rounded-lg' />
