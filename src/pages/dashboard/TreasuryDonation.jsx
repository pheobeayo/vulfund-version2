            ...
            <section className="bg-[#02080B] bg-no-repeat "
                ...
                <div className="px-4 mt-4 flex lg:flex-row md:flex-row flex-col justify-between font-bold text-white w-[100%] ">
                    <div className="flex gap-2">
                        <button className="bg-[#02080B] hover:bg-[#0A5B68] text-[14px] text-white border-[#C4D3D3] border font-bold py-2 px-4 rounded">
                            All Funding Requests
                        </button>
                        <Link to='/all-votedprojects'><button className="bg-[#02080B] text-[14px] hover:bg-[#0A5B68] text-white border-[#C4D3D3] border font-bold py-2 px-4 rounded">
                            All Voted Projects
                        </button></Link>
                        <Link to='/all-fundingprojects'>  <button className="bg-[#0A5B68] text-[14px] hover:bg-[#02080B] text-white font-bold py-2 px-4 rounded">
